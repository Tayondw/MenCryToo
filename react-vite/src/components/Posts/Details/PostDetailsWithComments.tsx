...
const PostDetailsWithComments: React.FC = () => {
	...
	// Enhanced comment organization function with better user data handling
	const organizeComments = useCallback(
		(flatComments: PostComment[]): Comment[] => {
			...
			flatComments.forEach((pc) => {
				...
				// If this is the session user's comment, use their data
				...
				// If this is the post creator's comment, use their data
	...
	const handleOpenComments = useCallback(() => {
		// Use the organized comments for the modal
...
const CommentThreadComponent: React.FC<CommentThreadComponentProps> = ({
	...
	// Memoized commenter data to prevent re-renders
...
// 		// Transform the post's comments to the expected format for the modal
// 		const transformPostCommentsForModal = (
// 			postComments: PostComment[],
// 		): Comment[] => {
// 			return postComments.map((pc) => ({
// 				id: pc.id,
// 				userId: pc.userId,
// 				postId: pc.postId,
// 				comment: pc.comment,
...
// 		// Use the original post comments for the modal
// 		const modalComments = transformPostCommentsForModal(
// 			post.postComments || [],
// 		);
// 		console.log("Opening modal with post comments:", modalComments);
// 		openCommentModal(post.id, modalComments);
// 	};
