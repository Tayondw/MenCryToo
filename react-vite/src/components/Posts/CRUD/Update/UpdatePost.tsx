...
const UpdatePost: React.FC = () => {
	...
	// Initialize form with post details
	useEffect(() => {
		if (sessionUser && postDetails) {
			setTitle(postDetails.title || "");
			setCaption(postDetails.caption || "");
			setPreviewImage(postDetails.image || null);
		}
			...
			<div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-slate-50 flex items-center justify-center p-4">
				<div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
					...
					<p className="text-slate-600 mb-6">
						You need to be logged in to update your post.
					</p>
						...
						<div className="relative rounded-2xl overflow-hidden shadow-xl">
							...
							<div className="absolute inset-0 bg-gradient-to-t from-slate-900/70 to-transparent flex items-end">
								<div className="p-8 text-white">
									<h2 className="text-3xl font-bold mb-2">Update Your Post</h2>
									<p className="text-slate-200">
										Refine your story and message
									</p>
								</div>
							</div>
						</div>
							...
							<div className="p-6">
								...
								<div className="space-y-4">
									...
									<div className="rounded-xl overflow-hidden border border-slate-200">
										<img
											src={previewImage || postDetails.image}
											alt="Preview"
						...
						<div className="flex items-center gap-4 mb-8">
							...
							<div>
								...
								<p className="text-slate-600">
									Refine your message and content
								</p>
							</div>
						</div>
						...
						>
							...
							<div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
								<div className="flex items-center gap-2 mb-2">
									...
									<h4 className="font-medium text-slate-800">Editing Tips</h4>
								</div>
								<ul className="text-sm text-slate-700 space-y-1 pl-6 list-disc">
									<li>Keep your title clear and concise</li>
									<li>
										Make sure your caption provides context for your image
									</li>
									<li>Consider how your post might help or inspire others</li>
