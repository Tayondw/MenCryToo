...
// OPTIMIZED: Fixed icon type and memoized navigation items
...
// OPTIMIZED: Memoized user menu with proper typing
const UserMenu = memo(
	({
		user,
		onLogout,
...
// OPTIMIZED: Main Navigation component with proper TypeScript
