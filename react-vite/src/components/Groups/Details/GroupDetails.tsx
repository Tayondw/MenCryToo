...
import DeleteGroup from "../CRUD/Delete/DeleteGroup";
import GroupImages from "../../Images/Groups/GroupImages";
									...
									<div className="grid grid-cols-2 md:grid-cols-3 gap-4">
										{groupDetails.groupImage?.map((image) => (
											<div
												...
												onClick={() => window.open(image.groupImage, "_blank")}
											>
												<img
													src={image.groupImage}
													alt={`Group photo ${image.id}`}
													className="w-full h-full object-cover"
												/>
											</div>
										))}
