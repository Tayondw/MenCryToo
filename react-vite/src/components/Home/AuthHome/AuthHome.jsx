		...
		<div id="auth-home">
			...
			<div id="create-profile">
				<div id="create-profile-header">
					...
					<h4>
						A better way to connect with others is to create a profile and let
						others get to know who you are and allow you to better find others
						who are like you
					</h4>
				</div>
					...
					{allGroups.groups.map((group) => (
						<div
							...
							<div id="group-carousel-navigation">
								...
								<span className="event-nav-indicator">{`${currentGroupIndex + 1} of ${
					...
					{allEvents.events.map((event) => (
						<div
							...
							<div id="event-carousel-navigation">
								...
								<span className="event-nav-indicator">{`${currentEventIndex + 1} of ${
