// Temporarily replace your CommentThread component with this minimal version to test visibility

import React from "react";
import type { CommentThreadProps } from "../../../types/comments";
...
const CommentThread: React.FC<CommentThreadProps> = ({
	...
	console.log("Rendering minimal CommentThread for comment:", comment);

	return (
		<div
			className={`comment-thread ${depth > 0 ? "ml-8" : ""}`}
			style={{
			...
			<div className="flex gap-3">
				...
				<div className="flex-shrink-0">
					<img
						...
						style={{ backgroundColor: "blue" }} // Visible placeholder
					/>
				</div>
				...
				<div className="flex-1 min-w-0">
					...
					<div className="flex items-center gap-2 mb-1">
						<span className="font-semibold text-gray-900 text-sm">
							{comment.commenter?.firstName || "Unknown"}{" "}
					...
					<div className="mb-2">
						<div className="text-gray-800 text-sm leading-relaxed">
							<strong>Comment ID {comment.id}:</strong> {comment.comment}
						</div>
					</div>
...
// 			onReply(comment.id, comment.commenter?.username || "");
// 			setIsReplying(false);
// 		} catch (error) {
